...
final class WinApplication extends Application implements InvokeLaterDispatcher.InvokeLaterSubmitter {
    ...
    private static boolean getBoolean(String var0, boolean var1, String var2) {
        ...
        if (var3 == null) {
            ...
            if (PrismSettings.verbose) {
                ...
                String var10001 = var4 ? "" : "not ";
                var10000.println(var10001 + var2);
            }
    ...
    protected void runLoop(Runnable var1) {
        ...
        if (var2) {
            ...
            Thread var5 = (Thread)AccessController.doPrivileged(() -> {
                return new Thread(() -> {
                    this._init(var3);
                    this._runLoop(var1);
    ...
    public String getHighContrastScheme(String var1) {
        ResourceBundle var10000 = ResourceBundle.getBundle("com/sun/glass/ui/win/themes");
        Objects.requireNonNull(var10000);
        return HighContrastScheme.fromThemeName(var10000::getString, var1);
    }
    ...
    static {
        Void var0 = (Void)AccessController.doPrivileged(new PrivilegedAction<Void>() {
            public Void run() {
